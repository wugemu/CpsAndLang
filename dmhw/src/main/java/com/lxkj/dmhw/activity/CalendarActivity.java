    ...
    public void onViewClicked(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.calendar_start_btn:
                ...
                selectedDate.set(Integer.parseInt(calendarStartBtnText.getText().toString().substring(0, 4)), Integer.parseInt(calendarStartBtnText.getText().toString().substring(5, 7)) - 1, Integer.parseInt(calendarStartBtnText.getText().toString().substring(8)));
            ...
            case R.id.calendar_end_btn:
                ...
                isCheck = false;
                selectedDate = Calendar.getInstance();
                selectedDate.set(Integer.parseInt(calendarEndBtnText.getText().toString().substring(0, 4)), Integer.parseInt(calendarEndBtnText.getText().toString().substring(5, 7)) - 1, Integer.parseInt(calendarEndBtnText.getText().toString().substring(8)));
                startDate = Calendar.getInstance();
