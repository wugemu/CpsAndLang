...
public class CommodityAdapter290 extends BaseQuickAdapter<MainBottomListItem, BaseViewHolder> {
    ...
    protected void convert(BaseViewHolder helper, MainBottomListItem item) {
        try {
            ...
            helper.setText(R.id.adapter_collection_discount,  item.getCoupon()+"元");
            ...
            if (DateStorage.getLoginStatus()){
                helper.setGone(R.id.adapter_collection_estimate,true);
                helper.setText(R.id.adapter_collection_estimate_text,  item.getNormalCommission());
            }else{
               helper.setGone(R.id.adapter_collection_estimate,false);
            }
