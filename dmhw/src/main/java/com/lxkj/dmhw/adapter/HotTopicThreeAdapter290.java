...
public class HotTopicThreeAdapter290 extends BaseQuickAdapter<HomePage.Banner, BaseViewHolder> {

    private Context context;
    private HotTopicThreeAdapter290.OnItemClickListener mListener;
    public void setOnItemClickListener(HotTopicThreeAdapter290.OnItemClickListener li) {
        mListener = li;
    }

    public HotTopicThreeAdapter290(Context context) {
