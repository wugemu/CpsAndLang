...
public class MorePlAdapterSearchStyle extends BaseQuickAdapter<JDGoodsBean, BaseViewHolder> {
    ...
    private MorePlAdapterSearchStyle.OnItemClickListener mListener;
    public void setOnItemClickListener(MorePlAdapterSearchStyle.OnItemClickListener li) {
        mListener = li;
    }
    private int platFrom=0;
    TextPaint tp;
    boolean showSales=false;
    public MorePlAdapterSearchStyle(Activity activity, int type, boolean issales) {
