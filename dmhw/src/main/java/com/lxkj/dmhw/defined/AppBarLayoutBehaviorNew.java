 ...
 */
public  class AppBarLayoutBehaviorNew extends AppBarLayout.Behavior {
    private static final String TAG = "AppbarLayoutBehavior";
    private static final int TYPE_FLING = 1;
    private boolean isFlinging;
    private boolean shouldBlockNestedScroll;
    public static boolean isSlidingMenuRight=true;
    public static boolean isSlidingMenuLeft=true;
    public AppBarLayoutBehaviorNew(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
...
//        if (isFlinging&&isSlidingMenuRight) {
//            InternalMessage.getInstance().eventMessage(LogicActions.getActionsSuccess("HideSlidingMenu"), "", 1);
//        }
    }
...
//        if (isSlidingMenuLeft) {
//            InternalMessage.getInstance().eventMessage(LogicActions.getActionsSuccess("HideSlidingMenu"), "", 0);
//        }
    }
