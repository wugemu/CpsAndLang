...
public class ConvenientBannerImage<T> extends LinearLayout {
    ...
    private FixedCBPageAdapter pageAdapter;
    private FixedCBLoopViewPager viewPager;
    ...
    public ConvenientBannerImage(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public ConvenientBannerImage(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public ConvenientBannerImage(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void init(Context context) {
        View hView = LayoutInflater.from(context).inflate(
                R.layout.include_viewpagernew, this, true);
        viewPager = (FixedCBLoopViewPager) hView.findViewById(R.id.cbLoopViewPagerNew);
    ...
    static class AdSwitchTask implements Runnable {
        ...
        private final WeakReference<ConvenientBannerImage> reference;

        AdSwitchTask(ConvenientBannerImage convenientBanner) {
            this.reference = new WeakReference<ConvenientBannerImage>(convenientBanner);
        }

        @Override
        public void run() {
            ConvenientBannerImage convenientBanner = reference.get();
    ...
    public ConvenientBannerImage setPages(CBViewHolderCreator holderCreator, List<T> datas){
        this.mDatas = datas;
        pageAdapter = new FixedCBPageAdapter(holderCreator,mDatas);
     ...
     * @param visible
     */
    public ConvenientBannerImage setPointViewVisible(boolean visible) {
     ...
     */
    public ConvenientBannerImage setPageIndicator(int[] page_indicatorId) {
     ...
     * @return
     */
    public ConvenientBannerImage setPageIndicatorAlign(PageIndicatorAlign align) {
     ...
     * @return
     */
    public ConvenientBannerImage startTurning(long autoTurningTime) {
        //如果是正在翻页的话先停掉
        if(turning){
            stopTurning();
        }
     ...
     * @return
     */
    public ConvenientBannerImage setPageTransformer(PageTransformer transformer) {
     ...
     * @return
     */
    public ConvenientBannerImage setOnPageChangeListener(ViewPager.OnPageChangeListener onPageChangeListener) {
     ...
     */
    public ConvenientBannerImage setOnItemClickListener(OnItemClickListener onItemClickListener) {
