 ...
 */
public class FixedCBPageAdapter<T> extends PagerAdapter {
...
//        if(onItemClickListener != null) view.setOnClickListener(onItemClickListener);
    ...
    public void setViewPager(FixedCBLoopViewPager viewPager) {
        this.viewPager = viewPager;
    }

    public FixedCBPageAdapter(CBViewHolderCreator holderCreator, List<T> datas) {
