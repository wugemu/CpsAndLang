 ...
 * 下拉刷新样式
 */
public class LoadMoreFooterViewFour extends FrameLayout implements PtrUIHandler {
...
//    private String beginText = "新内容很快就来了呦...";
    ...
    public LoadMoreFooterViewFour(Context context) {
        this(context, null);
    }

    public LoadMoreFooterViewFour(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public LoadMoreFooterViewFour(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(Context context) {
        ...
        view = layoutInflater.inflate(R.layout.view_load_more_four, this, true);
