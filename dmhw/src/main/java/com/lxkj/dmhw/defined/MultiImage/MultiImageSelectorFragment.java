...
import com.lxkj.dmhw.defined.MultiImage.adapter.FolderAdapter;
import com.lxkj.dmhw.defined.MultiImage.adapter.ImageGridAdapter;
import com.lxkj.dmhw.defined.MultiImage.model.Folder;
import com.lxkj.dmhw.defined.MultiImage.model.Image;
import com.lxkj.dmhw.defined.MultiImage.utils.FileUtils;
import com.lxkj.dmhw.defined.MultiImage.utils.ScreenUtils;
...
public class MultiImageSelectorFragment extends Fragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        drawable = resources.getDrawable(R.mipmap.mis_text_indicator);
        drawable.setBounds(0, 0, Utils.dipToPixel(R.dimen.dp_10), Utils.dipToPixel(R.dimen.dp_10));
        mCategoryText.setCompoundDrawables(null, null, drawable, null);
        mCategoryText.setText("所有照片");
        mCategoryText.setOnClickListener(views -> {
        ...
        mGridView.setOnItemClickListener((parent, views, position, id) -> {
    ...
    private void requestPermission(final String permission, String rationale, final int requestCode){
        if(shouldShowRequestPermissionRationale(permission)){
            new AlertDialog.Builder(getContext())
                    ...
                    .setPositiveButton("好", (dialog, which) -> requestPermissions(new String[]{permission}, requestCode))
