package com.lxkj.dmhw.defined.MultiImage.adapter;
...
public class FolderAdapter extends BaseAdapter {
    ...
    public FolderAdapter(Context context){
        ...
        mImageSize = Utils.dipToPixel(R.dimen.dp_82);
    }
                ...
                if(mFolders.size()>0){
                    ...
                    if (f != null) {
                        Glide.with(mContext)
                                ...
                                .override(Utils.dipToPixel(R.dimen.dp_82), Utils.dipToPixel(R.dimen.dp_82))
                                .centerCrop()
                                .into(holder.cover);
                    }else{
