...
public class SmoothCheckBox extends View implements Checkable {
    ...
    private static final int COLOR_FLOOR_UNCHECKED = Color.parseColor("#C9C9C9");
    ...
    private void init(AttributeSet attrs) {
        ...
        mCheckedColor = ta.getColor(R.styleable.SmoothCheckBox_color_checked, getResources().getColor(R.color.black));
        mUnCheckedColor = ta.getColor(R.styleable.SmoothCheckBox_color_unchecked, COLOR_UNCHECKED);
        mStrokeWidth = ta.getDimensionPixelSize(R.styleable.SmoothCheckBox_stroke_width, Utils.dipToPixel(R.dimen.dp_1));
        ta.recycle();
