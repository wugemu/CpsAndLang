 ...
 */
public class OtherFragment extends BaseFragment implements PtrHandler, BaseQuickAdapter.OnItemClickListener, BaseQuickAdapter.RequestLoadMoreListener {
    ...
    @Override
    public void onEvent() {
        categoryOne = getActivity().getIntent().getExtras().getInt("CategoryOne");
        categoryTwo = getActivity().getIntent().getExtras().getInt("CategoryTwo");
    ...
    private void httpPost(String time) {
        ...
        paramMap.put("shopclassone", categoryOne + "");
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.fragment_other_one:
                ...
                fragmentOtherOneText.setTextColor(getResources().getColor(R.color.mainColor));
            ...
            case R.id.fragment_other_two:
                ...
                fragmentOtherTwoText.setTextColor(getResources().getColor(R.color.mainColor));
                fragmentOtherThreeText.setTextColor(0xff666666);
                fragmentOtherFourText.setTextColor(0xff666666);
                switch (positionTwo) {
                    case 1:
            ...
            case R.id.fragment_other_three:
                ...
                fragmentOtherOneText.setTextColor(0xff666666);
                fragmentOtherTwoText.setTextColor(0xff666666);
                fragmentOtherThreeText.setTextColor(getResources().getColor(R.color.mainColor));
                fragmentOtherFourText.setTextColor(0xff666666);
            ...
            case R.id.fragment_other_four:
                ...
                fragmentOtherTwoText.setTextColor(0xff666666);
                fragmentOtherThreeText.setTextColor(0xff666666);
                fragmentOtherFourText.setTextColor(getResources().getColor(R.color.mainColor));
                switch (positionFour) {
                    case 1:
