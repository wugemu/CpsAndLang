...
public class TwoFragment_Marketing extends LazyFragment implements PtrHandler, BaseQuickAdapter.RequestLoadMoreListener,MarketingAdapter.OnItemImageClickListener{
    ...
    public static TwoFragment_Marketing getInstance(int pos,String key) {
        TwoFragment_Marketing fragment = new TwoFragment_Marketing();
    ...
    public void mainMessage(Message message) {
        ...
        //弹出一键发圈对话框
        if (message.what == LogicActions.oneKeyShareSuccess&&message.arg1==1&&type.equals(TwoFragment_MarketContent.currentFragmentName)) {
            dismissDialog();
    ...
    public void handlerMessage(Message message) {
        ...
        //一键发圈
        if (message.what == LogicActions.SendCircleMarketingSuccess&&type.equals(TwoFragment_MarketContent.currentFragmentName)) {
            dismissDialog();
   ...
   private boolean isfirst=true;
    ...
    public void onOneKey(Marketing.MarketingList item) {
        if (DateStorage.getLoginStatus()) {
            ...
            NetworkRequest.getInstance().POST(handler, paramMap, "SendCircleMarketing", HttpCommon.SendCircleMarketing);
        } else {
