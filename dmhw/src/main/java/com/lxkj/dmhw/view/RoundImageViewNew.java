...
public class RoundImageViewNew extends AppCompatImageView {
    ...
    public RoundImageViewNew(Context context, AttributeSet attrs, int defStyle) {
        ...
        type = array.getInt(R.styleable.RoundImageView_roundType, TYPE_CIRCLE);
        scaleType = array.getInt(R.styleable.RoundImageView_scale, SCALE_TYPE_CROP);
    ...
    protected void onRestoreInstanceState(Parcelable state) {
        if (state instanceof Bundle) {
            ...
            super.onRestoreInstanceState((Parcelable) ((Bundle) state).getSerializable(STATE_INSTANCE));
