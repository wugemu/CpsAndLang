    ...
    public TabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mScrollViewListener = new ScrollViewListener() {
            ...
            public void onScrollChanged(ScrollType scrollType) {
                TabLayout.this.scrollType=scrollType;
            }
        };
...
//        Log.i("linhanpeng","滚动状态="+scrollType);
        if (onScrollListener != null) {
            onScrollListener.onScroll(l,oldl);
        }
    }
    ...
    public interface OnScrollListener{
         ...
         * @param scrollX  scrollY
         */
        public void onScroll(int scrollX, int oldScrollX);
    }
