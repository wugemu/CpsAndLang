...
public class GroupTablayout extends FrameLayout {
    ...
    public GroupTablayout(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs,0);
    }

    public GroupTablayout(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private void initView(Context context){
        View view= LayoutInflater.from(context).inflate(R.layout.group_tablayout,null);
        addView(view);
            ...
            tabLayout.post(new Runnable() {
                ...
                public void run() {
                    try {
                        ...
                        mTabStrip.setBackgroundDrawable(new GroupProxyDrawable(mTabStrip));
