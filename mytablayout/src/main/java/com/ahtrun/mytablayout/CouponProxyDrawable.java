...
public class CouponProxyDrawable extends Drawable {
    ...
    public CouponProxyDrawable(View view) {
        mSelectedIndicatorHeight= (int) view.getContext().getResources().getDimension(R.dimen.dialog_sku_divider)*2;
        indicatorWidth=(int) view.getContext().getResources().getDimension(R.dimen.view_toview_two)*2;
        this.view = view;
        paint = new Paint();
        paint.setColor(0xFFFF1341);
