...
public class CouponTabLayout extends FrameLayout {

    private TabLayout tabLayout;
    private ViewPager viewPager;
    private MyFragmentPagerAdapter adapter;
    public CouponTabLayout(Context context) {
        this(context,null);
    }

    public CouponTabLayout(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs,0);
    }

    public CouponTabLayout(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private void initView(Context context){
        View view= LayoutInflater.from(context).inflate(R.layout.coupon_tablayout,null);
        addView(view);
            ...
            tabLayout.post(new Runnable() {
                ...
                public void run() {
                    try {
                        ...
                        mTabStrip.setBackgroundDrawable(new CouponProxyDrawable(mTabStrip));
