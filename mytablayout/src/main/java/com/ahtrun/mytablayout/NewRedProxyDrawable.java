...
public class NewRedProxyDrawable extends Drawable {
    View view;
    Paint paint;
    ...
    public NewRedProxyDrawable(View view) {
        mSelectedIndicatorHeight = (int) view.getContext().getResources().getDimension(R.dimen.dialog_sku_divider3);
