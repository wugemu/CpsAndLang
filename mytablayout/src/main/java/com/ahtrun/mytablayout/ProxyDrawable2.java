...
public class ProxyDrawable2 extends Drawable {
    View view;
    Paint paint;
    ...
    public ProxyDrawable2(View view) {
        mSelectedIndicatorHeight = (int) view.getContext().getResources().getDimension(R.dimen.dialog_sku_divider);
        indicatorWidth = (int) view.getContext().getResources().getDimension(R.dimen.indicator_width2);
        this.view = view;
        paint = new Paint();
