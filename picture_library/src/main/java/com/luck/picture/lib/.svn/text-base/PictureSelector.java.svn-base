...
public final class PictureSelector {
     ...
     * @param medias
     */
    public void externalPicturePreview(int position, List<LocalMedia> medias,boolean hiddenTopBar) {
        if (!DoubleUtils.isFastDoubleClick()) {
            ...
            intent.putExtra(PictureConfig.EXTRA_HIDDEN_TOPBAR,hiddenTopBar);
